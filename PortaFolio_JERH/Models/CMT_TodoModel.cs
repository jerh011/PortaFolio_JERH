...
{
    public class CMT_TodoModel
    {

        public string DaPe_Nombres { get; set; }
        public string DaPe_ApePa { get; set; }
        public string DaPe_ApeMa { get; set; }
        public string DaPe_Numero_cel { get; set; }
        public string DaPe_Correo1 { get; set; }
        ...
        public int Dic_NumeroDeCasa { get; set; }
        public string Dic_Coloniea { get; set; }
